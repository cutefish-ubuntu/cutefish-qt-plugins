 ...
 * Command line was: qdbusxml2cpp -m -a statusnotifieritemadaptor -i statusnotifier/statusnotifieritem.h -l StatusNotifierItem /root/Downloads/cutefish/qt-plugins/platformtheme/statusnotifier/org.kde.StatusNotifierItem.xml
 *
...
"  </interface>\n"
        "")
public:
    StatusNotifierItemAdaptor(StatusNotifierItem *parent);
    virtual ~StatusNotifierItemAdaptor();

    inline StatusNotifierItem *parent() const
    { return static_cast<StatusNotifierItem *>(QObject::parent()); }
